...
return (
    <Fragment>
        ...
        <div style={{ display: "flex", gap: "80px", padding: "0 80px", alignItems: "flex-start" }}>
            ...
            {product.gallery?.length > 0 && (
              <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginTop: "12px" }}>
                <img
                  ...
                  style={{ width: "70px", height: "70px", objectFit: "cover", cursor: "pointer", border: selectedImage === product.featuredImage ? "2px solid black" : "1px solid #ccc" }}
                />
                {product.gallery.map((img, i) => (
                  <img key={i} src={img.imagePath} alt={`gallery-${i}`}
                    onClick={() => setSelectedImage(img.imagePath)}
                    style={{ width: "70px", height: "70px", objectFit: "cover", cursor: "pointer", border: selectedImage === img.imagePath ? "2px solid black" : "1px solid #ccc" }}
                  />
                ))}
              </div>
            )}
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ marginBottom: "20px", display: "flex", flexDirection: "column", gap: "10px" }}>
              {product.materialName && (
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                  <span style={{ fontSize: "13px", fontWeight: "600", letterSpacing: "1px", fontFamily: "Times New Roman", minWidth: "80px" }}>STYLE :</span>
                  <span style={{ fontSize: "14px", color: "#555", fontFamily: "Times New Roman" }}>{product.materialName}</span>
                </div>
              )}
              {product.sizes?.length > 0 && (
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                  <span style={{ fontSize: "13px", fontWeight: "600", letterSpacing: "1px", fontFamily: "Times New Roman", minWidth: "80px" }}>SIZE :</span>
                  <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                    {product.sizes.map((size) => (
                      <div
                        ...
                        style={{
                          padding: "5px 14px", cursor: "pointer", fontFamily: "Times New Roman",
                          border: selectedSize === size.sizeID ? "2px solid black" : "1px solid #ccc",
                          fontSize: "13px", background: selectedSize === size.sizeID ? "#1a1a1a" : "white",
                          color: selectedSize === size.sizeID ? "white" : "#333"
                        }}
                      >
                        {size.sizeName}
                      </div>
              ...
              {product.qualityName && (
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                  <span style={{ fontSize: "13px", fontWeight: "600", letterSpacing: "1px", fontFamily: "Times New Roman", minWidth: "80px" }}>QUALITY :</span>
                  <span style={{ fontSize: "14px", color: "#555", fontFamily: "Times New Roman" }}>{product.qualityName}</span>
                </div>
              )}
              {/* DETAILS */}
            ...
            {product.colors?.length > 0 && (
              <div style={{ marginBottom: "25px" }}>
                <p style={{ fontSize: "13px", fontWeight: "600", letterSpacing: "1px", fontFamily: "Times New Roman", marginBottom: "10px" }}>
                  COLOR :
                </p>
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              {openSection === "details" && (
                <div className="info-content">
                  <ul>
                    {product.materialName && <li><strong>Style/Material:</strong> {product.materialName}</li>}
            ...
            {product.cataloguePDF && (
              <div style={{ marginTop: "20px" }}>
                <button
                  ...
                  style={{ cursor: "pointer", padding: "10px 24px", backgroundColor: "#1a1a1a", color: "white", border: "none", fontSize: "14px", letterSpacing: "1px", fontFamily: "Times New Roman" }}
                >
                  VIEW CATALOGUE PDF
                </button>
              </div>
      ...
      <section style={{ padding: "60px 80px", background: "white" }}>
        <h2 style={{ fontSize: "28px", fontWeight: "300", letterSpacing: "3px", fontFamily: "Times New Roman", marginBottom: "40px", color: "#1a1a1a" }}>
          RELATED PRODUCTS
        </h2>
          ...
          {relatedProducts.length > 0 ? relatedProducts.map((rp) => (
            ...
            >
              <div>
                ...
                <h3 style={{ fontSize: "16px", fontWeight: "300", letterSpacing: "1px", fontFamily: "Times New Roman", color: "#1a1a1a", textAlign: "center" }}>
                  {rp.productName}
                </h3>
              </div>
            </Link>
            ...
            [1,2,3].map((i) => (
              <div key={i} style={{ background: "#eee", height: "280px", display: "flex", alignItems: "center", justifyContent: "center", color: "#aaa", fontFamily: "Times New Roman" }}>
                No Related Product
              </div>
            ))
          )}
