    ...
    <>
      ...
      >
        <div className="tanshu-hover-card">
          <img src={himg} alt="Living room textile collection" className="tanshu-hover-image" />
          ...
          <div className="tanshu-hover-overlay">
            ...
            >
              <h2 className="tanshu-hover-title">LIVING ROOM:</h2>
              <p className="tanshu-hover-text">
                Crafted through generations of skill, our textiles bring together
                natural materials, refined textures, and a sense of quiet luxury
                designed for modern global living.
              </p>
            </div>
          </div>
        </div>
